...
RUN apt-get update && apt-get install -y \
    wget curl make nano gcc g++ gdb libssl-dev libssl1.1 git libcurl4-gnutls-dev libusb-dev libsqlite3-dev python3-dev zlib1g-dev libcereal-dev liblua5.3-dev uthash-dev perl cpanminus && \
